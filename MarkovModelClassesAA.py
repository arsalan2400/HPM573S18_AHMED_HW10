...
# -*- coding: utf-8 -*-
"""
Created on Mon Apr  16 04:18:30 2018
...
###THIS IS THE NEW COST FUNCTION FOR HW10!!!!!!#######    
...
#STEP 2 is the PATIENTSTATEMONITOR. THIS IS THE SAME#####
class PatientStateMonitor:
    ...
    def __init__(self, parameters):
        ...
        ###THIS IS NEW FOR WEEK 10#######
        
        # cost and utility outcomes
        self._costUtilityOutcomes = PatientCostUtility(parameters)
        
    
#### This is old stuff from HW9 as well. But we need to add info about Next_state
    def update(self, k, next_state):
        ...
        if self._currentState == P.HealthStats.STROKE and next_state == P.HealthStats.STROKE:
            ...
            self._strokecount = self.DELTA_T+1   # add 1 if the patient develop stroke

        # update current health state
        self._currentState = next_state

###THIS IS ALSO STRAIGHT FROM HW9!!!
...
##Unlike HW9, I need the Patient Cost utility Monitor for this HW9!!!###
...
##Write up the Cohort. This is cut and paste from HW9!!!!####
...
###Need to add some costing info here!!!####
class CohortOutputs:
    def __init__(self, simulated_cohort):
        ...
        self._strokecount = []        # patients' stroke times
        self._times_to_STROKE = []        # patients' times to stroke
        self._count_strokes = []
        ##I add back in costs and utilities!!
        ...
        # summary statistics, we added in sumStat_cost and_utility from SupportMarkovModel on Class folder
